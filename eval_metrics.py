...
def eval_videotag(distmat, q_pids, g_pids, max_rank):
...
def evaluate(distmat, q_pids, g_pids, q_camids, g_camids, max_rank=50, dataset_type='market1501', use_cython=True):
    if dataset_type == 'market1501':
        ...
        return eval_videotag(distmat, q_pids, g_pids, max_rank)